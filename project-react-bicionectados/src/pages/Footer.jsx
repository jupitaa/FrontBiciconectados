  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-section-contacto">
        <h2>Contacto</h2>
        <p><FontAwesomeIcon icon={faEnvelope} className="icon" /> contacto@biciconectados.cl</p>
        <p><FontAwesomeIcon icon={faPhoneAlt} className="icon" /> 600 600 6000</p>
      </div>
      <div className="footer-section-newsletter">
        <h3>BiciConectados</h3>
        <p>Suscríbete a nuestro Newsletter</p>
        <div className="newsletter-form">
          <input type="email" placeholder="Introduce tu email" className="newsletter-input" />
